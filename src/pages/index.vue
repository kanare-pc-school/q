      ...
      <div class="mt-2 overflow-hidden sm:rounded-lg p-6">
        <form class="w-full max-w-sm" @submit.prevent="submit">
          <div class="flex items-center border-b border-teal-500 py-2">
            <input v-model="$v.name.$model" class="appearance-none bg-transparent border-none w-full text-gray-700 mr-3 py-1 px-2 leading-tight focus:outline-none" type="text" placeholder="名前を入力してください" @keydown.enter="submit">
